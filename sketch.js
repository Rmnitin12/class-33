...
function setup() {
  ...
  var iphonetest = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent)
  ...
  button1.position(360,200)
  button1.size(50,50);
  button1.mouseClicked(drop1)

  button2 = createImg("cut_btn.png");
  button2.position(45,30)
  button2.size(50,50);
  ...
  rope = new Rope(5,{x:350,y:40});
  ground = new Ground(width/2,height-10,canw,20);

  rope1 = new Rope(4,{x:395,y:220});

  rope2 = new Rope(8,{x:35,y:45});

  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(width/4,height-150,100,100);
  bunny.scale = 0.4;
